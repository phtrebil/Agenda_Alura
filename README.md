...
Trata-se de um APP de agenda de alunos criada durante o curso de Android da Alura.
  ...
  1. Android parte 1: crie um app mobile.
     ...
     - [release/Trabalhando_arquivo_fonte_e_finalizando_fluxo_do_app](https://github.com/phtrebil/Agenda_Alura/edit/release/Trabalhando_arquivo_fonte_e_finalizando_fluxo_do_app/README.md)
